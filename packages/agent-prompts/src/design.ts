/**
 * @kealee/agent-prompts/design
 *
 * System prompt and context-aware prompt builders for DesignBot.
 * Source: extracted from bots/keabot-design/src/design.prompts.ts + design.types.ts
 */
