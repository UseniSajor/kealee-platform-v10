/**
 * @kealee/agent-prompts/marketing
 *
 * System prompt and day-specific prompt builders for MarketingBot.
 * Source: extracted from bots/keabot-marketing/src/marketing.prompts.ts + marketing.types.ts
 */

// ─── Types ────────────────────────────────────────────────────────────────────

export interface Day1SetupParams {
  domain: string;
  businessEmail: string;
  dnsProvider: string;
}

export interface Day2EmailParams {
  businessName: string;
  senderEmail: string;
  templates: string[];
  deliveryDays: number[];
...
export interface Day3LeadScoringParams {
...
// ─── Day-Specific Prompt Builders ─────────────────────────────────────────────

export function buildDay1SetupPrompt(params: Day1SetupParams): string {
  return `
...
export function buildDay2EmailPrompt(params: Day2EmailParams): string {
  return `
...
export function buildDay3LeadScoringPrompt(params: Day3LeadScoringParams): string {
  return `
