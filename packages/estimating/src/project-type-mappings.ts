...
export const PROJECT_TYPE_ASSEMBLIES: Record<string, ProjectTypeConfig> = {
  ...
  // ── Missing-Middle Housing Types (21st Century ROAD to Housing Act) ──────

  adu_new: {
    name: 'Accessory Dwelling Unit (ADU)',
    defaultSqft: 600,
    assemblies: [
      { code: 'GEN-SITE-PREP', quantityPer: 'sqft', multiplier: 1.2 },
      { code: 'FND-SLAB-4IN', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FRM-WALL-2X4', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'FRM-ROOF-TRUSS', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'ROOF-SHINGLE-ARCH', quantityPer: 'sqft', multiplier: 0.01 },
      { code: 'EXT-SIDING-LAP', quantityPer: 'sqft', multiplier: 3.0 },
      { code: 'KIT-CAB-STD', quantityPer: 'fixed', quantity: 12 },
      { code: 'KIT-COUNT-GRAN', quantityPer: 'fixed', quantity: 20 },
      { code: 'KIT-APPL-STD', quantityPer: 'fixed', quantity: 1 },
      { code: 'BATH-TILE-FLR', quantityPer: 'fixed', quantity: 40 },
      { code: 'BATH-VANITY-STD', quantityPer: 'fixed', quantity: 1 },
      { code: 'BATH-TOILET-STD', quantityPer: 'fixed', quantity: 1 },
      { code: 'BATH-TUB-STD', quantityPer: 'fixed', quantity: 1 },
      { code: 'MEP-ELEC-PANEL', quantityPer: 'fixed', quantity: 1 },
      { code: 'MEP-PLUMB-ROUGH', quantityPer: 'fixed', quantity: 1 },
      { code: 'MEP-HVAC-MINI', quantityPer: 'fixed', quantity: 1 },
      { code: 'KIT-FLOOR-STD', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'KIT-PAINT-INT', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'GEN-CLEANUP', quantityPer: 'sqft', multiplier: 1.0 },
    ],
  ...
  duplex_new: {
    name: 'Duplex (New Construction)',
    defaultSqft: 2400,
    assemblies: [
      { code: 'GEN-SITE-PREP', quantityPer: 'sqft', multiplier: 1.2 },
      { code: 'FND-SLAB-4IN', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FRM-WALL-2X4', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'FRM-FLOOR-2X10', quantityPer: 'sqft', multiplier: 0.5 },
      { code: 'FRM-ROOF-TRUSS', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'ROOF-SHINGLE-ARCH', quantityPer: 'sqft', multiplier: 0.01 },
      { code: 'EXT-SIDING-LAP', quantityPer: 'sqft', multiplier: 3.0 },
      { code: 'KIT-CAB-STD', quantityPer: 'fixed', quantity: 40 },
      { code: 'KIT-COUNT-GRAN', quantityPer: 'fixed', quantity: 60 },
      { code: 'KIT-APPL-STD', quantityPer: 'fixed', quantity: 2 },
      { code: 'BATH-TILE-FLR', quantityPer: 'fixed', quantity: 120 },
      { code: 'BATH-VANITY-STD', quantityPer: 'fixed', quantity: 4 },
      { code: 'BATH-TOILET-STD', quantityPer: 'fixed', quantity: 4 },
      { code: 'BATH-TUB-STD', quantityPer: 'fixed', quantity: 2 },
      { code: 'MEP-ELEC-PANEL', quantityPer: 'fixed', quantity: 2 },
      { code: 'MEP-PLUMB-ROUGH', quantityPer: 'fixed', quantity: 2 },
      { code: 'MEP-HVAC-SPLIT', quantityPer: 'fixed', quantity: 2 },
      { code: 'KIT-FLOOR-STD', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'KIT-PAINT-INT', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'GEN-DUMPSTER', quantityPer: 'fixed', quantity: 2 },
      { code: 'GEN-CLEANUP', quantityPer: 'sqft', multiplier: 1.0 },
  ...
  triplex_new: {
    ...
    assemblies: [
      ...
      { code: 'ROOF-SHINGLE-ARCH', quantityPer: 'sqft', multiplier: 0.01 },
      { code: 'EXT-SIDING-LAP', quantityPer: 'sqft', multiplier: 3.0 },
      { code: 'KIT-CAB-STD', quantityPer: 'fixed', quantity: 60 },
      { code: 'KIT-COUNT-GRAN', quantityPer: 'fixed', quantity: 90 },
      { code: 'KIT-APPL-STD', quantityPer: 'fixed', quantity: 3 },
      { code: 'BATH-TILE-FLR', quantityPer: 'fixed', quantity: 180 },
      { code: 'BATH-VANITY-STD', quantityPer: 'fixed', quantity: 6 },
      { code: 'BATH-TOILET-STD', quantityPer: 'fixed', quantity: 6 },
      { code: 'BATH-TUB-STD', quantityPer: 'fixed', quantity: 3 },
      { code: 'MEP-ELEC-PANEL', quantityPer: 'fixed', quantity: 3 },
      { code: 'MEP-PLUMB-ROUGH', quantityPer: 'fixed', quantity: 3 },
      { code: 'MEP-HVAC-SPLIT', quantityPer: 'fixed', quantity: 3 },
      { code: 'KIT-FLOOR-STD', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'KIT-PAINT-INT', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'GEN-DUMPSTER', quantityPer: 'fixed', quantity: 3 },
      { code: 'GEN-CLEANUP', quantityPer: 'sqft', multiplier: 1.0 },
    ],
  },

  fourplex_new: {
    name: 'Fourplex (New Construction)',
    defaultSqft: 4800,
    assemblies: [
      { code: 'GEN-SITE-PREP', quantityPer: 'sqft', multiplier: 1.2 },
      { code: 'FND-SLAB-4IN', quantityPer: 'sqft', multiplier: 1.0 },
      ...
      { code: 'ROOF-SHINGLE-ARCH', quantityPer: 'sqft', multiplier: 0.01 },
      { code: 'EXT-SIDING-LAP', quantityPer: 'sqft', multiplier: 3.0 },
      { code: 'KIT-CAB-STD', quantityPer: 'fixed', quantity: 80 },
      { code: 'KIT-COUNT-GRAN', quantityPer: 'fixed', quantity: 120 },
      { code: 'KIT-APPL-STD', quantityPer: 'fixed', quantity: 4 },
      { code: 'BATH-TILE-FLR', quantityPer: 'fixed', quantity: 240 },
      { code: 'BATH-VANITY-STD', quantityPer: 'fixed', quantity: 8 },
      { code: 'BATH-TOILET-STD', quantityPer: 'fixed', quantity: 8 },
      { code: 'BATH-TUB-STD', quantityPer: 'fixed', quantity: 4 },
      { code: 'MEP-ELEC-PANEL', quantityPer: 'fixed', quantity: 4 },
      { code: 'MEP-PLUMB-ROUGH', quantityPer: 'fixed', quantity: 4 },
      { code: 'MEP-HVAC-SPLIT', quantityPer: 'fixed', quantity: 4 },
      { code: 'KIT-FLOOR-STD', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'KIT-PAINT-INT', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'GEN-DUMPSTER', quantityPer: 'fixed', quantity: 3 },
      { code: 'GEN-CLEANUP', quantityPer: 'sqft', multiplier: 1.0 },
  ...
  townhouse_new: {
    name: 'Townhouse (New Construction)',
    defaultSqft: 1800,
    assemblies: [
      { code: 'GEN-SITE-PREP', quantityPer: 'sqft', multiplier: 1.2 },
      { code: 'FND-SLAB-4IN', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FRM-WALL-2X4', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'FRM-FLOOR-2X10', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FRM-ROOF-TRUSS', quantityPer: 'sqft', multiplier: 0.5 },
      { code: 'ROOF-SHINGLE-ARCH', quantityPer: 'sqft', multiplier: 0.005 },
      { code: 'EXT-SIDING-LAP', quantityPer: 'sqft', multiplier: 2.5 },
      { code: 'KIT-CAB-STD', quantityPer: 'fixed', quantity: 20 },
      { code: 'KIT-COUNT-GRAN', quantityPer: 'fixed', quantity: 30 },
      { code: 'KIT-APPL-STD', quantityPer: 'fixed', quantity: 1 },
      { code: 'BATH-TILE-FLR', quantityPer: 'fixed', quantity: 80 },
      { code: 'BATH-VANITY-STD', quantityPer: 'fixed', quantity: 3 },
      { code: 'BATH-TOILET-STD', quantityPer: 'fixed', quantity: 3 },
      { code: 'BATH-TUB-STD', quantityPer: 'fixed', quantity: 2 },
      { code: 'MEP-ELEC-PANEL', quantityPer: 'fixed', quantity: 1 },
      { code: 'MEP-PLUMB-ROUGH', quantityPer: 'fixed', quantity: 1 },
      { code: 'MEP-HVAC-SPLIT', quantityPer: 'fixed', quantity: 1 },
      { code: 'KIT-FLOOR-STD', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'KIT-PAINT-INT', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'GEN-DUMPSTER', quantityPer: 'fixed', quantity: 1 },
      { code: 'GEN-CLEANUP', quantityPer: 'sqft', multiplier: 1.0 },
  ...
  small_apartment_new: {
    name: 'Small Apartment (5-20 Units)',
    defaultSqft: 12000,
    assemblies: [
      { code: 'GEN-SITE-PREP', quantityPer: 'sqft', multiplier: 1.5 },
      { code: 'FND-SLAB-4IN', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FRM-WALL-2X6', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'FRM-FLOOR-2X10', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FRM-ROOF-TRUSS', quantityPer: 'sqft', multiplier: 0.35 },
      { code: 'ROOF-MEMBRANE', quantityPer: 'sqft', multiplier: 0.01 },
      { code: 'EXT-SIDING-LAP', quantityPer: 'sqft', multiplier: 2.5 },
      { code: 'KIT-CAB-STD', quantityPer: 'sqft', multiplier: 0.08 },
      { code: 'KIT-COUNT-LAM', quantityPer: 'sqft', multiplier: 0.04 },
      { code: 'KIT-APPL-STD', quantityPer: 'fixed', quantity: 12 },
      { code: 'BATH-TILE-FLR', quantityPer: 'fixed', quantity: 480 },
      { code: 'BATH-VANITY-STD', quantityPer: 'fixed', quantity: 16 },
      { code: 'BATH-TOILET-STD', quantityPer: 'fixed', quantity: 16 },
      { code: 'MEP-ELEC-PANEL', quantityPer: 'fixed', quantity: 12 },
      { code: 'MEP-PLUMB-ROUGH', quantityPer: 'fixed', quantity: 12 },
      { code: 'MEP-HVAC-SPLIT', quantityPer: 'fixed', quantity: 12 },
      { code: 'KIT-FLOOR-STD', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'KIT-PAINT-INT', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'GEN-DUMPSTER', quantityPer: 'fixed', quantity: 4 },
      { code: 'GEN-CLEANUP', quantityPer: 'sqft', multiplier: 1.0 },
    ],
  },
  ...
  mixed_use_new: {
    ...
    assemblies: [
      { code: 'GEN-SITE-PREP', quantityPer: 'sqft', multiplier: 1.5 },
      { code: 'FND-SLAB-6IN', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FRM-WALL-2X6', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'FRM-FLOOR-2X10', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FRM-ROOF-TRUSS', quantityPer: 'sqft', multiplier: 0.35 },
      { code: 'ROOF-MEMBRANE', quantityPer: 'sqft', multiplier: 0.01 },
      { code: 'EXT-SIDING-LAP', quantityPer: 'sqft', multiplier: 2.0 },
      { code: 'STOREFRONT-GLASS', quantityPer: 'fixed', quantity: 200 },
      { code: 'KIT-CAB-STD', quantityPer: 'fixed', quantity: 48 },
      { code: 'KIT-COUNT-GRAN', quantityPer: 'fixed', quantity: 60 },
      { code: 'KIT-APPL-STD', quantityPer: 'fixed', quantity: 6 },
      { code: 'BATH-TILE-FLR', quantityPer: 'fixed', quantity: 300 },
      { code: 'BATH-VANITY-STD', quantityPer: 'fixed', quantity: 8 },
      { code: 'BATH-TOILET-STD', quantityPer: 'fixed', quantity: 10 },
      { code: 'MEP-ELEC-PANEL', quantityPer: 'fixed', quantity: 8 },
      { code: 'MEP-PLUMB-ROUGH', quantityPer: 'fixed', quantity: 8 },
      { code: 'MEP-HVAC-SPLIT', quantityPer: 'fixed', quantity: 8 },
      { code: 'MEP-FIRE-SPRINK', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'KIT-FLOOR-STD', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'KIT-PAINT-INT', quantityPer: 'sqft', multiplier: 3.5 },
      { code: 'GEN-DUMPSTER', quantityPer: 'fixed', quantity: 4 },
      { code: 'GEN-CLEANUP', quantityPer: 'sqft', multiplier: 1.0 },
  ...
  modular_home: {
    ...
    defaultSqft: 1400,
    assemblies: [
      { code: 'GEN-SITE-PREP', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'FND-PIER-BLOCK', quantityPer: 'fixed', quantity: 20 },
      { code: 'MOD-UNIT-STD', quantityPer: 'sqft', multiplier: 1.0 },
      { code: 'MOD-SET-CRANE', quantityPer: 'fixed', quantity: 1 },
      { code: 'MOD-JOIN-SEAL', quantityPer: 'fixed', quantity: 1 },
      { code: 'EXT-SKIRT-VINYL', quantityPer: 'fixed', quantity: 160 },
      { code: 'MEP-ELEC-PANEL', quantityPer: 'fixed', quantity: 1 },
      { code: 'MEP-PLUMB-CONN', quantityPer: 'fixed', quantity: 1 },
      { code: 'MEP-HVAC-PKG', quantityPer: 'fixed', quantity: 1 },
      { code: 'DECK-WOOD-STD', quantityPer: 'fixed', quantity: 100 },
      { code: 'GEN-CLEANUP', quantityPer: 'sqft', multiplier: 1.0 },
    ],
  },
}
