...
export const PUBLIC_PRODUCT_CATALOG: readonly PublicCatalogProduct[] = [
  {
    ...
    startHref: '/get-started?service=preliminary_site_plan',
  ...
  },
  {
    ...
    startHref: '/get-started?service=verified_site_feasibility',
  ...
  },
  {
    ...
    startHref: '/get-started?service=developer_feasibility',
  ...
  },
  {
    ...
    startHref: '/get-started?service=project_launch',
  ...
  },
  {
    ...
    includes: ['Jurisdiction and approval-path research', 'Application and supporting-document checklist', 'Agency-fee guidance', 'Submission sequence and dependency map', 'Open questions requiring jurisdiction or professional confirmation'],
  ...
  },
  {
    ...
    includes: ['Application preparation and document organization', 'Filing support and submission tracking', 'Agency correspondence record', 'Coordinated response checklist', 'Portal status and document handoff'],
  ...
  },
  {
    ...
    startHref: '/get-started?service=permit_site_plan',
    ...
    includes: ['Boundary or survey intake and quality check', 'Jurisdiction-specific drawing scope', 'Site-plan drafting coordination', 'Required professional-review workflow', 'Comment-response scope definition'],
  ...
  },
  {
    ...
    includes: ['Professional scope and code-path confirmation', 'Required architectural or engineering drawings', 'Interdisciplinary coordination as scoped', 'Professional review and seal when contracted and required', 'Permit-submission document handoff'],
