    ...
    >
      ...
      <div className="flex items-start gap-4 mb-4">
        ...
        {logo ? (
          ...
          <div className="w-14 h-14 rounded-lg bg-[#4A90D9] text-white flex items-center justify-center flex-shrink-0 font-bold text-lg">
        ...
        <div className="flex-grow min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <h4 className="font-bold text-[#4A90D9] truncate">{businessName}</h4>
            <span className={cn(
      ...
      <div className="flex items-center justify-between mb-4 text-sm">
        <div className="flex items-center gap-1">
          ...
          <span className="font-semibold text-[#4A90D9]">{rating.toFixed(1)}</span>
        ...
        <div className="grid grid-cols-3 gap-2 mb-4 text-center">
          {stats.projectsCompleted !== undefined && (
            <div className="bg-gray-50 rounded-lg py-2">
              <p className="text-lg font-bold text-[#4A90D9]" style={{ fontFamily: '"JetBrains Mono", monospace' }}>
      ...
      <Link
        href={ctaHref}
        className="block w-full py-2.5 text-center rounded-lg border-2 border-[#4A90D9] text-[#4A90D9] font-semibold text-sm hover:bg-[#4A90D9] hover:text-white transition-colors"
      >
        View Profile
      </Link>
    </div>
