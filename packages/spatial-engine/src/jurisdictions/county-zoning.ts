...
const LC_DENSITY = (d: string) => `No minimum lot size; density is capped at ${d}.`
export const LOUDOUN_STANDARDS: Record<string, CountyZoneStandard> = {
  ...
  'R-2': { zone: 'R-2', lotAreaSqFt: null, lotWidthFt: 60, frontFt: 25, sideFt: 12, sideSumFt: null, rearFt: 25, coveragePct: 40, heightFt: 40, citation: LC('2.02.05.01-1'), notes: [LC_DENSITY('1 dwelling per 20,000 SF'), LC_SIDE, LC_OPTION, LC_ROAD] },
  'R-3': { zone: 'R-3', lotAreaSqFt: null, lotWidthFt: 50, frontFt: 25, sideFt: 12, sideSumFt: null, rearFt: 25, coveragePct: 40, heightFt: 40, citation: LC('2.02.05.01-1'), notes: [LC_DENSITY('1 dwelling per 15,000 SF'), LC_SIDE, LC_OPTION, LC_ROAD] },
  'R-4': { zone: 'R-4', lotAreaSqFt: null, lotWidthFt: 50, frontFt: 25, sideFt: 9, sideSumFt: null, rearFt: 25, coveragePct: 35, heightFt: 40, citation: LC('2.02.05.02-1'), notes: [LC_DENSITY('1 dwelling per 10,000 SF'), LC_OPTION, LC_ROAD] },
  'R-8': { zone: 'R-8', lotAreaSqFt: null, lotWidthFt: 40, frontFt: 15, sideFt: 8, sideSumFt: null, rearFt: 25, coveragePct: 50, heightFt: 40, citation: LC('2.02.05.03-1'), notes: [LC_DENSITY('8 dwellings per acre'), 'Single-family detached figures.', LC_ROAD] },
  ...
  'CR-2': { zone: 'CR-2', lotAreaSqFt: null, lotWidthFt: 50, frontFt: 25, sideFt: 12, sideSumFt: null, rearFt: 50, coveragePct: 40, heightFt: 35, citation: LC('2.04.03.03-1'), notes: [LC_DENSITY('1 lot per 40,000 SF (base density)'), LC_SIDE, LC_OPTION, LC_ROAD] },
  'CR-3': { zone: 'CR-3', lotAreaSqFt: null, lotWidthFt: 50, frontFt: 25, sideFt: 12, sideSumFt: null, rearFt: 50, coveragePct: 40, heightFt: 35, citation: LC('2.04.03.03-1'), notes: [LC_DENSITY('1 lot per 40,000 SF (base density)'), LC_SIDE, LC_OPTION, LC_ROAD] },
  'CR-4': { zone: 'CR-4', lotAreaSqFt: null, lotWidthFt: 50, frontFt: 25, sideFt: 12, sideSumFt: null, rearFt: 50, coveragePct: 35, heightFt: 35, citation: LC('2.04.03.03-1'), notes: [LC_DENSITY('1 lot per 40,000 SF (base density)'), LC_SIDE, LC_OPTION, LC_ROAD] },
  ...
  'TR-10': { zone: 'TR-10', lotAreaSqFt: null, lotWidthFt: null, frontFt: 20, sideFt: 7, sideSumFt: null, rearFt: 25, coveragePct: null, heightFt: 40, citation: LC('2.03.01-1'), notes: [LC_DENSITY('1 dwelling per 10 acres'), 'Setback adjacent to roads per §7.04.02.'] },
  'TR-3': { zone: 'TR-3', lotAreaSqFt: null, lotWidthFt: null, frontFt: 12, sideFt: 7, sideSumFt: null, rearFt: 25, coveragePct: null, heightFt: 40, citation: LC('2.03.01-1'), notes: [LC_DENSITY('1 dwelling per 3 acres'), 'Setback adjacent to roads per §7.04.02.'] },
  'TR-1': { zone: 'TR-1', lotAreaSqFt: null, lotWidthFt: null, frontFt: 10, sideFt: 5, sideSumFt: null, rearFt: 25, coveragePct: null, heightFt: 40, citation: LC('2.03.01-1'), notes: [LC_DENSITY('1 dwelling per 40,000 SF'), 'Setback adjacent to roads per §7.04.02.'] },
}
