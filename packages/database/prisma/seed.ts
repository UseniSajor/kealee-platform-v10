...
async function main() {
  ...
  // ============================================================================
  // CASE STUDIES — Marketing Funnel seed data
  // ============================================================================
  console.log("📸 Seeding case studies...");
  const caseStudies = [
    {
      title: "Modern Kitchen Transformation in Bethesda",
      description: "Complete gut renovation of a 1960s kitchen into a modern open-concept space with custom cabinetry, quartz countertops, and professional-grade appliances.",
      projectType: "KITCHEN_REMODEL" as const,
      city: "Bethesda",
      state: "MD",
      budget: "85000.00",
      durationWeeks: 10,
      highlights: ["Custom Cabinetry", "Quartz Countertops", "Open Concept"],
      isPublished: true,
      isFeatured: true,
    },
    {
      title: "Luxury Bathroom Suite in McLean",
      description: "Spa-inspired master bathroom featuring heated floors, frameless glass shower, freestanding tub, and custom vanity with double sinks.",
      projectType: "BATHROOM_REMODEL" as const,
      city: "McLean",
      state: "VA",
      budget: "62000.00",
      durationWeeks: 8,
      highlights: ["Heated Floors", "Frameless Shower", "Freestanding Tub"],
      isPublished: true,
      isFeatured: true,
    },
    {
      title: "Whole Home Renovation in Capitol Hill",
      description: "Full renovation of a historic rowhouse including structural updates, new HVAC, updated electrical, and period-appropriate finishes throughout.",
      projectType: "WHOLE_HOME" as const,
      city: "Washington",
      state: "DC",
      budget: "325000.00",
      durationWeeks: 20,
      highlights: ["Historic Preservation", "Full MEP Update", "Period Finishes"],
      isPublished: true,
      isFeatured: true,
    },
    {
      title: "Two-Story Addition in Silver Spring",
      description: "Added 800 sq ft including a new master suite, walk-in closet, and home office above an expanded family room.",
      projectType: "ADDITION" as const,
      city: "Silver Spring",
      state: "MD",
      budget: "195000.00",
      durationWeeks: 16,
      highlights: ["Master Suite", "Home Office", "800 sq ft Added"],
      isPublished: true,
      isFeatured: false,
    },
    {
      title: "New Construction Townhome in Arlington",
      description: "Ground-up construction of a modern 3-story townhome with rooftop terrace, smart home integration, and energy-efficient systems.",
      projectType: "NEW_CONSTRUCTION" as const,
      city: "Arlington",
      state: "VA",
      budget: "475000.00",
      durationWeeks: 32,
      highlights: ["Smart Home", "Rooftop Terrace", "Energy Efficient"],
      isPublished: true,
      isFeatured: false,
    },
    {
      title: "Exterior Facelift in Chevy Chase",
      description: "Complete exterior renovation including new siding, windows, roofing, and a redesigned front porch with stone accents.",
      projectType: "EXTERIOR" as const,
      city: "Chevy Chase",
      state: "MD",
      budget: "48000.00",
      durationWeeks: 6,
      highlights: ["New Siding", "Energy Windows", "Stone Porch"],
      isPublished: true,
      isFeatured: false,
    },
    {
      title: "Backyard Oasis in Falls Church",
      description: "Complete landscape redesign with paver patio, outdoor kitchen, fire pit area, native plantings, and landscape lighting.",
      projectType: "LANDSCAPING" as const,
      city: "Falls Church",
      state: "VA",
      budget: "35000.00",
      durationWeeks: 5,
      highlights: ["Outdoor Kitchen", "Fire Pit", "Native Plants"],
      isPublished: true,
      isFeatured: false,
    },
    {
      title: "Restaurant Build-Out in Georgetown",
      description: "Commercial kitchen build-out and dining room renovation for a new farm-to-table restaurant, including hood systems, walk-in cooler, and ADA compliance.",
      projectType: "COMMERCIAL" as const,
      city: "Washington",
      state: "DC",
      budget: "280000.00",
      durationWeeks: 14,
      highlights: ["Commercial Kitchen", "ADA Compliant", "Farm-to-Table"],
      isPublished: true,
      isFeatured: false,
    },
    {
      title: "Chef's Kitchen in Potomac",
      description: "High-end kitchen renovation featuring Sub-Zero and Wolf appliances, custom island with waterfall edge, and butlers pantry.",
      projectType: "KITCHEN_REMODEL" as const,
      city: "Potomac",
      state: "MD",
      budget: "145000.00",
      durationWeeks: 12,
      highlights: ["Sub-Zero/Wolf", "Waterfall Island", "Butler's Pantry"],
      isPublished: true,
      isFeatured: false,
    },
    {
      title: "Condo Bathroom Remodel in Dupont Circle",
      description: "Efficient bathroom remodel in a pre-war condo building, maximizing space with a walk-in shower, floating vanity, and built-in storage.",
      projectType: "BATHROOM_REMODEL" as const,
      city: "Washington",
      state: "DC",
      budget: "28000.00",
      durationWeeks: 4,
      highlights: ["Space Maximized", "Walk-in Shower", "Built-in Storage"],
      isPublished: true,
      isFeatured: false,
    },
    {
      title: "Historic Home Restoration in Old Town Alexandria",
      description: "Sensitive restoration of a 1790s colonial home including foundation repair, plaster restoration, and modern systems hidden within historic walls.",
      projectType: "WHOLE_HOME" as const,
      city: "Alexandria",
      state: "VA",
      budget: "410000.00",
      durationWeeks: 28,
      highlights: ["Foundation Repair", "Plaster Restoration", "Hidden Systems"],
      isPublished: true,
      isFeatured: true,
    },
    {
      title: "Sunroom Addition in Rockville",
      description: "Three-season sunroom addition with floor-to-ceiling windows, radiant floor heating, and seamless connection to the existing living space.",
      projectType: "ADDITION" as const,
      city: "Rockville",
      state: "MD",
      budget: "72000.00",
      durationWeeks: 8,
      highlights: ["Floor-to-Ceiling Windows", "Radiant Heat", "Three-Season"],
      isPublished: true,
      isFeatured: false,
    },
  ];
