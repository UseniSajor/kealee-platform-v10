...
--
-- Mirrors the Prisma models added in commit f052d027 (which shipped without
-- a migration, breaking every /api/editor/* route in production). Idempotent
-- so it can co-exist with packages/database/migrations/20260509_pascal_editor.sql
-- if that raw file was already applied manually.
-- ─────────────────────────────────────────────────────────────────────────────
