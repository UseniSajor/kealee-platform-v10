...
export function normalizeCaptureSession(raw: Record<string, unknown>): CaptureSessionRecord {
  return {
    ...
    capture_mode: (raw.capture_mode as CaptureSessionRecord["capture_mode"]) ?? "self_capture",
    ...
    site_visit_status: (raw.site_visit_status as CaptureSessionRecord["site_visit_status"]) ?? "not_scheduled",
