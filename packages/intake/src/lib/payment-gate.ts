...
const PAYMENT_REASONS: Record<ProjectPath, string> = {
  ...
  kitchen_remodel: "Kitchen remodel intake covers scope review, layout analysis, and material direction.",
  bathroom_remodel: "Bathroom remodel intake covers scope review, fixture planning, and design direction.",
  ...
  capture_site_concept: "Capture-only path — no payment required for mobile property capture.",
};
