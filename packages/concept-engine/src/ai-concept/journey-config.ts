...
> = {
  ...
  townhome_subdivision: {
    ...
    upsellServices: ['civil_engineering', 'architectural_package', 'structural_engineering', 'permit_expediting', 'build_ops'],
    minBudget: '500k',
    maxBudget: '10M+',
    typicalTimeline: '18–36 months',
  },
  ...
  single_lot_development: {
    ...
    upsellServices: ['architectural_package', 'structural_engineering', 'permit_expediting', 'contractor_matching'],
    minBudget: '100k',
    maxBudget: '2M',
