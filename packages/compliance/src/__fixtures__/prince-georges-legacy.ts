import type { JurisdictionCheckResult, JurisdictionOutcome, JurisdictionRulePack, RuleAuthority } from '../jurisdiction-rules'

/**
 * Test-only fixture: the original hardcoded princeGeorgesCountyRulePack evaluator, preserved
 * verbatim as the oracle for the DB-seeded rule-engine parity tests. This is NOT production
 * code — nothing outside __tests__ may import it. The real, live rules are data-driven rows
 * in JurisdictionRuleVersion (see prince-georges-rule-data.ts / rule-engine.ts).
 */
