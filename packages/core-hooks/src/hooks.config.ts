...
export const REVENUE_HOOKS: Record<HookStage, RevenueHook> = {
  ...
  project_intake: {
    ...
    subheadline:    'Get an design concept, zoning check, cost band, and permit risk — all in one $395 report.',
    ...
    tiers: [
      ...
      },
      {
        ...
        price:       39500,
        priceLabel:  '$395',
        description: 'design concept + zoning check + structural review + cost band + permit risk. Delivered in 24 hours.',
        features:    ['design concept & floor plan', 'Zoning confirmed', 'Structural risk assessment', 'Cost band ($X–$Y)', 'Permit risk rating', 'Contractor scope notes'],
    ...
    tiers: [
      {
        ...
        price:       0,
        priceLabel:  'Included',
        description: 'generated using AI tools estimate with line items and totals.',
  ...
  permit_detected: {
    ...
    subheadline:    'Most permits require professional architectural or engineering plans. Choose the level of support you need.',
    ...
    tiers: [
      {
        ...
        price:       0,
        priceLabel:  'Free',
        description: 'generated using AI tools permit checklist for your project and jurisdiction.',
      ...
      },
      {
        ...
        price:       14900,
        priceLabel:  '$149',
        description: 'Filing service for straightforward single-trade permits where owner-provided plans are accepted.',
        features:    ['Application forms', 'Single-trade scope (e.g. electrical, plumbing)', 'Status tracking', 'Jurisdiction checklist'],
        cta:         'File my permit',
      ...
      },
      {
        ...
        price:       95000,
        priceLabel:  '$950',
        description: 'Full permit prep for projects requiring professional architectural or engineering plans — submitted and tracked to approval.',
        features:    ['Professional plan requirement review', 'Drawing preparation & stamping coordination', 'Supporting documentation', 'Application submission + status tracking'],
      ...
      },
      {
        ...
        price:       275000,
        priceLabel:  '$2,750',
        description: 'Full-service coordination for complex permits requiring licensed professional plans — we manage everything from plan review to final approval.',
        features:    ['Everything in Package', 'Licensed architect/engineer coordination', 'Plan review comment responses', 'Multiple jurisdiction management', 'Approval through closeout'],
