/**
 * @kealee/agent-utils/monitoring/types
 *
 * Types for project monitoring, issue detection, and milestone tracking.
 * Source: extracted from bots/keabot-project-monitor/src/types.ts
 */
