/**
 * @kealee/agent-utils/monitoring/status
 *
 * Project phase progress percentages and display labels.
 *
 * Source: extracted from bots/keabot-project-monitor/src/status.ts
...
const PHASE_PROGRESS: Record<ProjectPhase, number> = {
  ...
  mep:                  65,
  finishing:            80,
  inspection_scheduled: 85,
  inspection_passed:    90,
  inspection_failed:    85,
...
export { PHASE_PROGRESS, PHASE_LABELS };
