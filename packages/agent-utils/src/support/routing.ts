/**
 * @kealee/agent-utils/support/routing
 *
 * Keyword-based support ticket classifier.
 * Routes to permit_specialist, contractor_manager, billing_team, design_team,
 * estimation_team, ai_assistant, or general_support.
 *
 * Source: extracted from bots/keabot-support/src/routing.ts
 * Pure function — no I/O, no LLM, no database.
 */

import type { RoutingResult, SupportCategory } from './types';
