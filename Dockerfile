...
ARG NEXT_PUBLIC_COMMAND_CENTER_URL
ARG NEXT_PUBLIC_ADMIN_CONSOLE_URL
ARG NEXT_PUBLIC_PORTAL_OWNER_URL
ARG NEXT_PUBLIC_PORTAL_CONTRACTOR_URL
ARG NEXT_PUBLIC_PORTAL_DEVELOPER_URL
ARG NEXT_PUBLIC_MARKETPLACE_URL
ARG NEXT_PUBLIC_MARKETING_OS_URL
ENV NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL \
    NEXT_PUBLIC_SUPABASE_ANON_KEY=$NEXT_PUBLIC_SUPABASE_ANON_KEY \
    NEXT_PUBLIC_APP_URL=$NEXT_PUBLIC_APP_URL \
    NEXT_PUBLIC_API_URL=$NEXT_PUBLIC_API_URL \
    NEXT_PUBLIC_COMMAND_CENTER_URL=$NEXT_PUBLIC_COMMAND_CENTER_URL \
    NEXT_PUBLIC_ADMIN_CONSOLE_URL=$NEXT_PUBLIC_ADMIN_CONSOLE_URL \
    NEXT_PUBLIC_PORTAL_OWNER_URL=$NEXT_PUBLIC_PORTAL_OWNER_URL \
    NEXT_PUBLIC_PORTAL_CONTRACTOR_URL=$NEXT_PUBLIC_PORTAL_CONTRACTOR_URL \
    NEXT_PUBLIC_PORTAL_DEVELOPER_URL=$NEXT_PUBLIC_PORTAL_DEVELOPER_URL \
    NEXT_PUBLIC_MARKETPLACE_URL=$NEXT_PUBLIC_MARKETPLACE_URL \
    NEXT_PUBLIC_MARKETING_OS_URL=$NEXT_PUBLIC_MARKETING_OS_URL
