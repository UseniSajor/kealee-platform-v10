...
import { getProduct, getAllProductSlugs, isMarketingProductSlug } from '@/lib/products'
import ProductCheckoutButton from '@/components/ProductCheckoutButton'
import { MarketingProductDetail } from '@/components/marketing/MarketingProductDetail'
...
export default function ProductPage({ params }: { params: { slug: string } }) {
  ...
  if (isMarketingProductSlug(params.slug)) {
    return <MarketingProductDetail product={product} />
  }
