      ...
      <section className="bg-navy py-16">
        <div className="mx-auto max-w-2xl px-4 text-center sm:px-6">
          ...
          <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              href="/concept?feature=milestone-pay"
              className="inline-flex items-center gap-2 rounded-xl bg-builder-orange-light px-6 py-3 text-sm font-semibold text-white transition-opacity hover:opacity-90"
            >
              Start a project with Milestone Pay <ArrowRight className="h-4 w-4" aria-hidden />
            </Link>
            <Link
              href="/marketplace"
