    ...
    <div className='concept-page'>
      ...
      <section className='faq'>
        ...
        <div className='faq-grid'>
          ...
          <FAQ
            question="Can you recommend contractors?"
            answer="We provide your concept to our contractor network, who can bid on your project. However, we don't dictate contractor selection — you maintain full control."
          />
          ...
          <FAQ
            question="What if my area isn't supported?"
            answer="We're expanding zoning coverage. If your jurisdiction isn't available, contact us for a timeline."
          />
        </div>
      </section>
