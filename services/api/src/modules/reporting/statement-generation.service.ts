...
export const statementGenerationService = new StatementGenerationService()
 ...
 + content.summary.openingBalance.toFixed(2) + '</td></tr>',
      '<tr><td>Total Deposits</td><td>
...
export const statementGenerationService = new StatementGenerationService()
 ...
 + content.summary.totalDeposits.toFixed(2) + '</td></tr>',
      '<tr><td>Total Releases</td><td>
...
export const statementGenerationService = new StatementGenerationService()
 ...
 + content.summary.totalReleases.toFixed(2) + '</td></tr>',
      '<tr><td>Total Fees</td><td>
...
export const statementGenerationService = new StatementGenerationService()
 ...
 + content.summary.totalFees.toFixed(2) + '</td></tr>',
      '<tr><td>Closing Balance</td><td>
...
export const statementGenerationService = new StatementGenerationService()
 ...
 + content.summary.closingBalance.toFixed(2) + '</td></tr>',
      '</table></body></html>',
    ].join('\n')
