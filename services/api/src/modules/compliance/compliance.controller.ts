...
export class ComplianceController {
  ...
  async getStateRules(
    ...
    try {
      const { state } = stateRulesSchema.parse(request.params as any);
  ...
  async runComplianceCheck(
    ...
    try {
      const { userId } = complianceCheckSchema.parse(request.body as any);
  ...
  async validateLicense(
    ...
    try {
      const { userId, licenseNumber, state } = validateLicenseSchema.parse(request.body as any);
  ...
  async validateInsurance(
    ...
    try {
      const { userId, policyNumber } = validateInsuranceSchema.parse(request.body as any);
  ...
  async checkBondRequirements(
    ...
    try {
      const { contractId } = bondRequirementsSchema.parse(request.body as any);
  ...
  async generateComplianceReport(
    ...
    try {
      const { startDate, endDate } = complianceReportSchema.parse(request.query as any);
