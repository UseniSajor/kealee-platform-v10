...
vi.mock('@kealee/kealee-agent-stack', async () => {
  ...
  return {
    ...
    V30_BOT_REGISTRY: {
      design:     { type: 'design',     displayName: 'DesignBot',     defaultModel: 'claude-opus-5',    timeoutSeconds: 120 },
      estimate:   { type: 'estimate',   displayName: 'EstimateBot',   defaultModel: 'claude-sonnet-5',  timeoutSeconds: 90  },
      floorplan:  { type: 'floorplan',  displayName: 'FloorplanBot',  defaultModel: 'claude-sonnet-5',  timeoutSeconds: 90  },
      permit:     { type: 'permit',     displayName: 'PermitBot',     defaultModel: 'claude-sonnet-5',  timeoutSeconds: 90  },
      video:      { type: 'video',      displayName: 'VideoBot',      defaultModel: 'claude-sonnet-5',  timeoutSeconds: 60  },
    },
