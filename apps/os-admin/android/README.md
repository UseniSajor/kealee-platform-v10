# Kealee Admin — Android / Google Play

This Bubblewrap project packages `https://admin.kealee.com/` as a
Trusted Web Activity.

## Identity

- Package ID: `com.kealee.admin`
- Target SDK: Android 16 / API 36
- Minimum SDK: API 21
- Web origin: `https://admin.kealee.com`
- Manifest: `https://admin.kealee.com/site.webmanifest`
- Digital Asset Links: `https://admin.kealee.com/.well-known/assetlinks.json`
