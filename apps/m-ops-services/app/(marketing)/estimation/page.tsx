...
export default function EstimationPage() {
  ...
  const aiFeatures = [
    {
      ...
      description: 'Machine learning models trained on thousands of real projects for accurate predictions.',
    },
    {
      icon: '📊',
      title: 'Market Data Integration',
      description: 'Real-time material pricing and labor rates from your local market.',
    },
    {
      icon: '⚡',
      title: 'Fast Turnaround',
      description: 'Get estimates in as little as 24 hours—no more waiting weeks for quotes.',
    },
    {
      icon: '🎯',
  ...
  const processSteps = [
    {
      ...
      description: 'Upload plans, photos, and project requirements through our secure portal.',
    },
    {
      step: 2,
      title: 'AI Analysis',
      description: 'Our engine analyzes your project using historical data and current market rates.',
    },
    {
      step: 3,
      title: 'Expert Review',
      description: 'A human estimator reviews and validates the AI-generated estimate.',
    },
    {
      step: 4,
      title: 'Receive Report',
      description: 'Get a detailed cost breakdown with actionable insights for your bid.',
    },
  ];
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-12">
      ...
      <section className="mb-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {aiFeatures.map((feature) => (
            <div
              key={feature.title}
              className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm text-center"
            >
          ...
          {processSteps.map((step, index) => (
            <div key={step.step} className="relative">
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 text-blue-700 font-black text-xl mb-4">
                  {step.step}
                </div>
      ...
      {/* Pricing Tiers */}
      <section className="mb-16">
        <h2 className="text-2xl font-black text-center mb-4">Estimation Packages</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {estimationTiers.map((tier) => (
            ...
            >
              ...
              <div className="mt-2 text-3xl font-black text-blue-600">{tier.price}</div>
              <p className="text-sm text-zinc-500 mt-1">Turnaround: {tier.turnaround}</p>
              ...
              <p className="mt-4 text-xs text-zinc-500">Best for: {tier.bestFor}</p>
              <Link
                href="/signup"
                className={`mt-4 block text-center py-2.5 rounded-lg font-bold transition ${
                  tier.popular
      ...
      <section className="rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 p-8">
        <h2 className="text-xl font-black mb-6 text-center">Every Estimate Includes</h2>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="text-2xl mb-2">📋</div>
            <h3 className="font-bold">Labor Analysis</h3>
            <p className="text-sm text-zinc-600 mt-1">Hours, rates, and crew sizing for each trade</p>
          </div>
          <div className="text-center">
            <div className="text-2xl mb-2">🧱</div>
            <h3 className="font-bold">Material Takeoffs</h3>
            <p className="text-sm text-zinc-600 mt-1">Quantities and current pricing from suppliers</p>
          </div>
          <div className="text-center">
            <div className="text-2xl mb-2">📅</div>
            <h3 className="font-bold">Timeline Projection</h3>
            <p className="text-sm text-zinc-600 mt-1">Phase-by-phase schedule with milestones</p>
          </div>
        </div>
      </section>
    </main>
