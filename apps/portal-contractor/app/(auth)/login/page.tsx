  ...
  return (
    <div className="rounded-2xl border p-8 shadow-2xl" style={{ borderColor: '#2A3D5F', backgroundColor: '#1A2B4A' }}>
      <div className="mb-6 text-center">
        ...
        <h1 className="font-display text-2xl font-bold text-white">Contractor Portal</h1>
        <p className="mt-1 text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>Sign in to manage leads and projects</p>
      </div>
