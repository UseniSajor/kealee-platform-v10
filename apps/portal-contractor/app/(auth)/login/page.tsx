  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-xl">
      <div className="mb-6 text-center">
        ...
        <h1 className="font-display text-2xl font-bold" style={{ color: '#1A2B4A' }}>Contractor Portal</h1>
        <p className="mt-1 text-sm text-gray-600">Sign in to manage leads and projects</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              style={{ '--tw-ring-color': '#2ABFBF', borderColor: undefined } as React.CSSProperties}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 py-2.5 pl-10 pr-10 text-sm focus:outline-none focus:ring-1"
              onFocus={(e) => { e.target.style.borderColor = '#2ABFBF'; e.target.style.boxShadow = '0 0 0 1px #2ABFBF' }}
              onBlur={(e) => { e.target.style.borderColor = '#d1d5db'; e.target.style.boxShadow = 'none' }}
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        New contractor?{' '}
        <Link href="/signup" className="font-medium hover:underline" style={{ color: '#2ABFBF' }}>Apply now</Link>
      </p>
    </div>
  )
}
