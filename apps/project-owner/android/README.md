# Kealee Project Owner — Android / Google Play

This Bubblewrap project packages `https://owner.kealee.com/projects` as a
Trusted Web Activity.

## Identity

- Package ID: `com.kealee.projectowner`
- Target SDK: Android 16 / API 36
- Minimum SDK: API 21
- Web origin: `https://owner.kealee.com`
- Manifest: `https://owner.kealee.com/site.webmanifest`
- Digital Asset Links: `https://owner.kealee.com/.well-known/assetlinks.json`
