  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex items-center gap-4">
        <Link href="/estimates"><Button variant="ghost" size="sm"><ArrowLeft size={16} className="mr-1" /> Back to Estimates</Button></Link>
      </div>

      <div>
        <h1 className="text-3xl font-bold text-gray-900">New Estimate</h1>
        <p className="text-gray-500 mt-1">Create a construction cost estimate with detailed line items</p>
      </div>
