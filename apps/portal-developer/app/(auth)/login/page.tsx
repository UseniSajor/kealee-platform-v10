  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-xl">
      <div className="mb-6 text-center">
        ...
        <h1 className="font-display text-2xl font-bold" style={{ color: '#1A2B4A' }}>Developer Portal</h1>
        <p className="mt-1 text-sm text-gray-600">Manage your land pipeline and portfolio</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input id="password" type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)}
              className="w-full rounded-lg border border-gray-300 py-2.5 pl-10 pr-10 text-sm focus:border-teal focus:outline-none focus:ring-1 focus:ring-teal"
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        New developer?{' '}
        <Link href="/signup" className="font-medium hover:underline" style={{ color: '#2ABFBF' }}>Create an account</Link>
      </p>
    </div>
  )
}
