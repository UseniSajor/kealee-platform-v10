...
import {VideoConference} from '@permits/src/components/video-inspection/video-conference';
import {GuidedInspection} from '@permits/src/components/video-inspection/guided-inspection';
import {AIAnalysisOverlay} from '@permits/src/components/video-inspection/ai-analysis-overlay';
import {VideoInspection, VideoAIAnalysis} from '@permits/src/types/video-inspection';
import {postProcessingService} from '@permits/src/services/video-inspection/post-processing';
...
export default function VideoInspectionPage() {
  ...
  const handleEndCall = async () => {
    ...
    if (inspection.aiAnalysis) {
      ...
      window.location.href = `/permits/dashboard/video-inspections/${inspectionId}/report`;
    } else {
      // Navigate to inspection list
      window.location.href = '/permits/dashboard/inspections';
    }
  };
