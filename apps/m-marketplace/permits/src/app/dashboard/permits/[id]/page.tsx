...
import { PermitDocuments } from '@permits/src/components/permit/permit-documents';
import { PermitCorrections } from '@permits/src/components/permit/permit-corrections';
import { PermitInspections } from '@permits/src/components/permit/permit-inspections';
import { formatCurrency, formatDate } from '@permits/src/lib/utils';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/permits/dashboard/permits">
