...
import {permitSearchService, PublicPermitInfo} from '@permits/src/services/public-portal/permit-search';
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-4">
                    <Button
                      variant="outline"
                      onClick={() => {
                        window.location.href = `/permits/public/permit/${permit.permitId}`;
                      }}
                    >
                      View Details
                    </Button>
