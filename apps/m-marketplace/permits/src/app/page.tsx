        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link href="/permits/auth/login" className="text-emerald-600 font-semibold hover:underline">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/permits/public/search" className="hover:text-white transition">
                    Public Permit Search
                  </Link>
                </li>
                <li>
                  <Link href="/permits/public/faq" className="hover:text-white transition">
                    FAQ
                  </Link>
                </li>
              </ul>
