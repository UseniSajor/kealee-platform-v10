...
import { cn } from '@permits/src/lib/utils';
import {
  LayoutDashboard,
  FileText,
  ClipboardCheck,
...
const clientNavItems = [
  { href: '/permits/dashboard', label: 'Overview', icon: LayoutDashboard },
  { href: '/permits/dashboard/permits', label: 'Permits', icon: FileText },
  { href: '/permits/dashboard/permits/new', label: 'New Application', icon: PlusCircle },
  { href: '/permits/dashboard/inspections', label: 'Inspections', icon: ClipboardCheck },
  { href: '/permits/dashboard/settings', label: 'Settings', icon: Settings },
];

const pmNavItems = [
  { href: '/permits/dashboard', label: 'Overview', icon: LayoutDashboard },
  { href: '/permits/dashboard/permits', label: 'All Permits', icon: FileText },
  { href: '/permits/dashboard/inspections', label: 'Inspections', icon: ClipboardCheck },
  { href: '/permits/dashboard/jurisdictions', label: 'Jurisdictions', icon: MapPin },
  { href: '/permits/dashboard/settings', label: 'Settings', icon: Settings },
];
