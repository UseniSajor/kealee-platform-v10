...
import {
  ...
  CardHeader,
  CardTitle,
} from '@permits/src/components/ui/card';
import {
  Form,
  FormControl,
  FormDescription,
  ...
  FormLabel,
  FormMessage,
} from '@permits/src/components/ui/form';
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@permits/src/components/ui/select';
...
import FileUpload from '@permits/src/components/file-upload';
import { PermitApiService } from '@permits/src/lib/api/permits';
