...
import { Separator } from "@ops/components/ui"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/ops/development" className="text-sm hover:text-orange-600 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/ops/development/services" className="text-sm hover:text-orange-600 transition-colors">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/ops/development/how-it-works" className="text-sm hover:text-orange-600 transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
                <Link href="/ops/development/experience" className="text-sm hover:text-orange-600 transition-colors">
                  Experience
                </Link>
              </li>
              <li>
                <Link href="/ops/development/contact" className="text-sm hover:text-orange-600 transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="/ops/legal/privacy" className="hover:text-orange-600 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/ops/legal/acceptable-use" className="hover:text-orange-600 transition-colors">
              Acceptable Use
            </Link>
