...
import { Menu, X, ChevronDown, Building2, FileCheck, Users, Pencil, Phone, ArrowRight } from 'lucide-react';
...
const services = [
  ...
  },
  {
    ...
    description: 'Track milestones and manage contractors',
    href: '/services/portal',
    icon: Users,
  },
  {
    name: 'Architect Services',
    description: 'Professional design and permit-ready plans',
    href: '/services/architect',
    icon: Pencil,
  },
  {
    name: 'Permits & Inspections',
    description: 'AI-powered permit review and approval',
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/25 group-hover:shadow-blue-500/40 transition-shadow">
            ...
            >
              <button
                className={`flex items-center gap-1.5 px-4 py-2.5 rounded-lg font-medium transition-all ${
                  scrolled ? 'text-slate-700 hover:text-blue-600 hover:bg-blue-50' : 'text-slate-800 hover:text-blue-600'
                }`}
              >
                Services
                <ChevronDown
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Link
              href="/signup"
              className="group relative px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:from-blue-700 hover:to-blue-800 transition-all overflow-hidden"
            >
