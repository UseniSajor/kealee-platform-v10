        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link
                href="/permits/permits/login"
                className="text-sm font-medium text-gray-700 hover:text-emerald-600 transition"
              >
                Log In
              </Link>
              <Link
                href="/permits/permits/new"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link href="/permits/permits/new" className="text-emerald-600 font-semibold hover:underline">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mt-auto pt-3 border-t border-gray-100">
                    ...
                    <Link href="/permits/permits/contact" className="text-xs text-emerald-600 font-semibold hover:underline ml-auto">
                      Details →
                    </Link>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/permits/permits/status" className="hover:text-white transition">
                    Permit Status Search
                  </Link>
                </li>
                <li>
                  <Link href="/permits/legal/privacy" className="hover:text-white transition">
                    Privacy Policy
                  </Link>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            ...
            <div className="flex gap-6 mt-4 md:mt-0">
              ...
              <Link href="/permits/legal/acceptable-use" className="hover:text-white transition">
                Acceptable Use
              </Link>
            </div>
          </div>
