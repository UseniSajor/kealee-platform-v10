      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/permits/permits/contractors" className="flex items-center space-x-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/permits/permits/contractors/services" className="text-sm hover:text-emerald-600 transition-colors">Permit Services</Link></li>
                <li><Link href="/permits/permits/contractors/pricing" className="text-sm hover:text-emerald-600 transition-colors">Pricing</Link></li>
                <li><Link href="/permits/permits/contractors/how-it-works" className="text-sm hover:text-emerald-600 transition-colors">How It Works</Link></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-gray-400 flex flex-col items-center gap-4">
            <div className="flex gap-6">
              <a href="/permits/legal/terms" className="hover:text-white transition-colors">Terms of Service</a>
