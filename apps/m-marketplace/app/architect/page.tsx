      ...
      <nav className="border-b border-gray-200 bg-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/architect/schedule" className="text-gray-600 hover:text-gray-900 text-sm">
              Schedule
            </Link>
            <Link href="/architect/team" className="text-gray-600 hover:text-gray-900 text-sm">
              Team
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <Link href="/architect/projects" className="text-sm text-indigo-600 hover:text-indigo-700 font-medium">
              View All →
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <Link href="/architect/help" className="hover:text-white">Help</Link>
              <Link href="/architect/team" className="hover:text-white">Team</Link>
          ...
          <div className="border-t border-gray-800 mt-6 pt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-sm">
            ...
            <div className="flex gap-6 justify-center md:justify-end">
              ...
              <Link href="/architect/legal/acceptable-use" className="hover:text-white">Acceptable Use</Link>
            </div>
          </div>
        </div>
      </footer>
