...
const heroImage = { src: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1920&q=80&auto=format&fit=crop', alt: 'Aerial view of a construction site with cranes and workers' };
