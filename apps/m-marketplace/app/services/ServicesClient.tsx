  ...
  return (
    <div className="svc-page" ref={containerRef}>
      ...
      <div className="phase-bar">
        {([
          { id: 'design' as Phase, label: 'Design', sub: 'Architecture · design concepts' },
      ...
      <div className={`panel ${activePhase === 'design' ? 'active' : ''}`}>
        <section className="svc-hero hero-design">
          <div className="hero-inner">
            <div>
              <div className="hero-badge"><span className="badge-dot" /> powered by AI tools · Licensed Architect Review</div>
              ...
              <div className="hero-btns fu3">
                <Link href="/get-started" className="btn-hero-gold">Start with design concept — $99</Link>
        ...
        <section className="sec accent-teal scroll-reveal">
          ...
          <div className="rail">
            ...
            <div className="rail-step"><div className="rail-num"><div className="step-ball ball-teal">3</div></div><div className="rail-body"><span className="rail-tag tag-arch">Architect Review</span><h3 className="rail-title">A Licensed Architect Reviews Every Drawing</h3><p className="rail-desc">Every generated using AI tools concept is reviewed, refined, and approved by a licensed architect before you receive it. No exceptions, no shortcuts.</p><div className="chips"><span className="chip">Code Compliance Check</span><span className="chip">Design Refinements</span><span className="chip">Quality Assurance</span><span className="chip">Architect Approval</span></div></div></div>
        ...
        <section className="sec scroll-reveal">
          ...
          <p className="sec-p">Start with an design concept to validate your vision, then upgrade to full architectural services when you&apos;re ready to build.</p>
          <div className="pkg-tabs">
            <button className={`pkg-tab ${activePkgTab === 'ai' ? 'active' : ''}`} onClick={() => switchPkg('ai')}>design concept Generation</button>
        ...
        <section className="sec-dark cta scroll-reveal">
          ...
          <p>Start with a $99 design concept. 48-hour delivery. Money-back if you&apos;re not satisfied.</p>
          <div className="cta-btns"><Link href="/get-started" className="btn-hero-gold">Get My design concept — From $99</Link><Link href="/contact" className="btn-hero-outline">Talk to an Architect</Link></div>
      ...
      <div className={`panel ${activePhase === 'estimate' ? 'active' : ''}`}>
        <section className="svc-hero hero-estimate">
          <div className="hero-inner">
            <div>
              <div className="hero-badge"><span className="badge-dot" /> powered by AI tools Estimation · Real Cost Databases</div>
        ...
        <section className="sec scroll-reveal">
          ...
          <div className="audience-split">
            ...
            <div className="aud-pane aud-pane-gc">
              ...
              <ul className="aud-list">
                <li><span className="pchk chk-navy" style={{flexShrink:0}}>✓</span>Command center: 14 powered by AI tools automation mini-apps</li>
                <li><span className="pchk chk-navy" style={{flexShrink:0}}>✓</span>GPS &amp; biometric crew check-in</li>
                <li><span className="pchk chk-navy" style={{flexShrink:0}}>✓</span>generated using AI tools daily logs from field data</li>
      ...
      <div className={`panel ${activePhase === 'closeout' ? 'active' : ''}`}>
        ...
        <section className="sec accent-gold scroll-reveal">
          ...
          <div className="escrow-flow" style={{marginBottom:56}}>
            ...
            <div className="ef-step"><div className="ef-circle" style={{background:'#EFF6FF'}}>📋</div><div className="ef-title">Punch List Issued</div><div className="ef-desc">assisted by AI tools walkthrough generates comprehensive punch list</div></div>
