...
export const metadata: Metadata = {
  ...
  description: 'Explore Kealee\'s complete construction services — powered by AI tools design concepts, cost estimation, permit automation, PM software, ops services, escrow & closeout. Pricing for every phase.',
  openGraph: {
  ...
  keywords: [
    'construction services', 'architecture packages', 'design concept design', 'cost estimation pricing',
