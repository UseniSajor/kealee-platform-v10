    ...
    <div className="w-full">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight">Contractor Network</h1>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <Link href="/contact" className="inline-flex items-center justify-center rounded-xl border border-gray-300 bg-white px-6 py-3 text-sm font-semibold text-gray-900 shadow-sm transition hover:bg-gray-50">Join as Contractor</Link>
          </div>
        </div>
