...
import { useRunAITakeoff } from "@pm/hooks/useEstimates"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-500">Upload project plans and photos for automatic quantity extraction</p>
        </div>
      </div>
                  ...
                  {files.map(f => (
                    <div key={f.id} className="flex items-center gap-3 p-3 border rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-400">{formatFileSize(f.size)} Â· {f.type}</p>
                      </div>
        ...
        <>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Processed in {result.processingTime}s Â· {result.totalItems} items extracted Â· {result.averageConfidence}% avg confidence</p>
                </div>
              </div>
          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-3">
              ...
              <Button className="gap-2" onClick={() => router.push("/pm/estimates/new")}>
