...
import type { Lead, LeadStage } from "@pm/lib/types"
  ...
  if (error || !lead) {
    return (
      <div className="space-y-6">
        ...
        <Button variant="outline" onClick={() => router.push("/pm/pipeline")}>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="outline" size="sm" onClick={() => router.push("/pm/pipeline")}>
          <ArrowLeft className="h-4 w-4" />
          Back
        </Button>
        <div>
              ...
              {lead.stage === "WON" && lead.awardedProfile && !lead.projectId && (
                <Button
                  ...
                  onClick={() => {
                    ...
                    alert("Project creation from lead will be implemented. Use POST /pm/projects/from-lead/:leadId")
                  }}
                >
