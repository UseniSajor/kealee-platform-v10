    ...
    <div className="space-y-6">
      ...
      {activeTab === "schedule" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/schedule"><Button>Open Schedule</Button></Link>
        </CardContent></Card>
      )}
      ...
      {activeTab === "documents" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/documents"><Button>Open Documents</Button></Link>
        </CardContent></Card>
      )}
      ...
      {activeTab === "photos" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/photos"><Button>Open Photos</Button></Link>
        </CardContent></Card>
      )}
      ...
      {activeTab === "rfis" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/rfis"><Button>Open RFIs</Button></Link>
        </CardContent></Card>
      )}
      ...
      {activeTab === "submittals" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/submittals"><Button>Open Submittals</Button></Link>
        </CardContent></Card>
      )}
            ...
            <Card>
              ...
              <CardContent>
                <div className="py-8 text-center">
                  ...
                  <Link href="/pm/field-conflicts/new">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card className="hover:shadow-md transition-shadow">
              <CardContent className="pt-6 pb-4 text-center">
                ...
                <Link href="/pm/multifamily/units"><Button variant="outline" size="sm" className="w-full">Open Unit Tracker</Button></Link>
              </CardContent>
            </Card>
            <Card className="hover:shadow-md transition-shadow">
              <CardContent className="pt-6 pb-4 text-center">
                ...
                <Link href="/pm/multifamily/draws"><Button variant="outline" size="sm" className="w-full">Open Lender Draws</Button></Link>
              </CardContent>
            </Card>
            <Card className="hover:shadow-md transition-shadow">
              <CardContent className="pt-6 pb-4 text-center">
                ...
                <Link href="/pm/multifamily/phasing"><Button variant="outline" size="sm" className="w-full">Open Area Phasing</Button></Link>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      {activeTab === "punch-list" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/punch-list"><Button>Open Punch List</Button></Link>
        </CardContent></Card>
      )}
      ...
      {activeTab === "change-orders" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/change-orders"><Button>Open Change Orders</Button></Link>
        </CardContent></Card>
      )}
      ...
      {activeTab === "daily-logs" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/daily-logs"><Button>Open Daily Logs</Button></Link>
        </CardContent></Card>
      )}
      ...
      {activeTab === "safety" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/safety"><Button>Open Safety</Button></Link>
        </CardContent></Card>
      )}
      ...
      {activeTab === "drawings" && (
        <Card><CardContent className="py-12 text-center">
          ...
          <Link href="/pm/drawings"><Button>Open Drawings</Button></Link>
        </CardContent></Card>
      )}
