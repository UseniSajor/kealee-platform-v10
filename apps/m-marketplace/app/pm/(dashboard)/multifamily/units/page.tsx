...
import { useCreateUnit, useBulkCreateUnits, useUpdateUnit } from "@pm/hooks/useMultifamily"
...
export default function UnitTrackerPage() {
  ...
  function generateBulkUnits() {
    ...
    // Persist bulk units to API (fire & forget â€” local state already updated)
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-400">
                        {unit.building} Â· Floor {unit.floor}
                      </p>
                    </div>
                    <span
