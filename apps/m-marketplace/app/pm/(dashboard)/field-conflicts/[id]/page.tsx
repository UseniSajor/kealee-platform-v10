...
} from "@pm/hooks/useFieldConflicts"
  ...
  if (!conflict) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/pm/field-conflicts" className="text-blue-600 text-sm mt-2 inline-block">
