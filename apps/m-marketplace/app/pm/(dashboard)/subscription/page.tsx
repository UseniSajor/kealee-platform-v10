...
// â”€â”€ Tier metadata â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function SubscriptionPage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (params.get('success') === 'true') {
        ...
        window.history.replaceState({}, '', '/pm/subscription')
      }
    }
  }, [])
  ...
  const handleManageBilling = async () => {
    ...
    try {
      const res = await api.subscription.createPortalSession(`${window.location.origin}/pm/subscription`)
      if (res?.url) {
      ...
      {!isPmService && (
        <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-dashed border-gray-200">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/pm/subscription/pricing#full-service"
...
// â”€â”€ Usage Card Component â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
