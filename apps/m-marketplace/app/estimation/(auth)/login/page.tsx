    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-900 via-amber-800 to-slate-900 flex items-center justify-center px-6">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="mt-6 text-center text-sm text-gray-500">Don&apos;t have an account? <a href="/estimation/signup" className="text-amber-600 hover:text-amber-700 font-semibold">Sign up</a></p>
        </div>
      </div>
    </div>
  );
