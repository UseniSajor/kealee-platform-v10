...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@estimation/components/ui/accordion"
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Our assisted by AI tools estimates achieve 95% accuracy on average when measured against actual project costs. Accuracy depends on the completeness of project information provided.",
  },
  {
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Self-serve estimation tools with powered by AI tools features</p>
          </div>
