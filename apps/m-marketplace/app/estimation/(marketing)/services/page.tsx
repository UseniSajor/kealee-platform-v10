...
const services = [
  {
    ...
    features: ["Same-day delivery", "powered by AI tools analysis", "Confidence ranges included", "Regional cost adjustments"],
  ...
  },
  {
    ...
    features: ["powered by AI tools alternatives", "10-25% typical savings", "Quality impact analysis", "Implementation roadmap"],
  ...
  },
  {
    ...
    description: "assisted by AI tools quantity extraction from project plans. Upload PDFs or CAD files and receive organized quantity reports by CSI division.",
