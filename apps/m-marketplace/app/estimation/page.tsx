...
import { AIEstimationFeatures } from "@estimation/components/marketing/AIEstimationFeatures"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/estimation/services" className="text-sm hover:text-blue-400 transition-colors">Estimation Services</Link></li>
                <li><Link href="/estimation/pricing" className="text-sm hover:text-blue-400 transition-colors">Pricing</Link></li>
                <li><Link href="/estimation/how-it-works" className="text-sm hover:text-blue-400 transition-colors">How It Works</Link></li>
              </ul>
            </div>
            <div>
