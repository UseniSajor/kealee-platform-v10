      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              ...
              <label className="text-sm text-gray-600">
                I agree to the{' '}
                <a href="/engineer/terms" className="text-teal-600 hover:text-teal-700">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="/engineer/privacy" className="text-teal-600 hover:text-teal-700">
                  Privacy Policy
                </a>
              </label>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <a href="/engineer/login" className="text-teal-600 hover:text-teal-700 font-semibold">
              Sign in
            </a>
          </p>
        </div>
