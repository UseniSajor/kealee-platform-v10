...
import { getProjects, type EngineeringProject } from "@engineer/lib/api";
      ...
      <header className="bg-white border-b border-zinc-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/engineer" className="text-xl font-black text-blue-600">
              Kealee Engineering
            </Link>
            <nav className="flex items-center gap-6 text-sm">
              ...
              <Link href="/engineer/projects" className="text-blue-600 font-semibold">My Projects</Link>
              <Link href="/engineer/contact" className="px-4 py-2 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700">
                New Project
              </Link>
            </nav>
          </div>
