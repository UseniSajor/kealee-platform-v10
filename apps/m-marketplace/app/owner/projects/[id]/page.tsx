...
import { api, type ReadinessItem } from '@owner/lib/api'
import { ReadinessItemCompletionForm } from '@owner/components/ReadinessItemCompletionForm'
    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-6">
      <nav aria-label="Breadcrumb" className="text-sm text-neutral-600">
        <ol className="flex flex-wrap items-center gap-2">
          ...
          <li>
            <Link className="underline underline-offset-4" href="/owner/projects/new">
              Projects
            </Link>
          </li>
          <li aria-hidden="true">/</li>
        ...
        <>
          ...
          <section className="mt-6 rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <Link
                href={`/owner/projects/${params.id}/contracts/new`}
                className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700"
              >
                + New Contract
              </Link>
            ...
            <div className="mt-4 flex gap-4">
              <Link
                href={`/owner/projects/${params.id}/contracts`}
          ...
          {(project.status === 'CLOSEOUT' || project.status === 'COMPLETED') ? (
            <section className="mt-6 rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4">
                <Link
                  href={`/owner/projects/${params.id}/closeout`}
                  className="text-sm text-blue-600 underline underline-offset-4"
                >
