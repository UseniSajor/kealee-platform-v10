...
import { api, Milestone } from '@owner/lib/api'
import MilestoneSubmissionForm from '@owner/components/MilestoneSubmissionForm'
import EvidenceReviewPanel from '@owner/components/EvidenceReviewPanel'
import PaymentReleasePanel from '@owner/components/PaymentReleasePanel'
    ...
    <main className="mx-auto w-full max-w-4xl px-4 py-6">
      <nav aria-label="Breadcrumb" className="text-sm text-neutral-600">
        <ol className="flex flex-wrap items-center gap-2">
          ...
          <li aria-hidden="true">/</li>
          <li>
            <Link className="underline underline-offset-4" href={`/owner/projects/${params.id}/milestones`}>
              Milestones
            </Link>
          </li>
          <li aria-hidden="true">/</li>
      ...
      <div className="mt-6 space-y-6">
        ...
        <section className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <Link
              href={`/owner/projects/${params.id}/milestones`}
