...
export default function ProjectTimelinePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    // fetch(`/api/qa/owner/projects/${params.id}/timeline`)
    // fetch(`/api/qa/owner/projects/${params.id}/before-after`)
    setLoading(false);
  }, [params.id]);
            ...
            {(timeline?.entries || []).length === 0 ? (
              <div className="text-center py-16 bg-white rounded-xl border border-gray-200">
                ...
                <p className="text-gray-400 text-xs mt-4">
                  GET /api/qa/owner/projects/{params.id}/timeline
                </p>
              </div>
            ) : (
          ...
          <div>
            {pairs.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-xl border border-gray-200">
                ...
                <p className="text-gray-400 text-xs mt-4">
                  GET /api/qa/owner/projects/{params.id}/before-after
                </p>
              </div>
            ) : (
