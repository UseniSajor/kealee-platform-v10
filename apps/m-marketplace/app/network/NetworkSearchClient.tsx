...
export function NetworkSearchClient({ initialProfiles }: NetworkSearchClientProps) {
  ...
  const filteredProfiles = useMemo(() => {
    ...
    return results;
  }, [initialProfiles, searchQuery, selectedTypes, selectedSectors, minRating, selectedAvailability, sortBy]);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-gray-600">
              Showing <span className="font-semibold">{filteredProfiles.length}</span> professionals
            </p>
          </div>
