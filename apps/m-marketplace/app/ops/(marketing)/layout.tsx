          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/ops/packages" className="hover:text-white transition">PM Packages</Link></li>
                <li><Link href="/ops/pm-software" className="hover:text-white transition">PM Software</Link></li>
                <li><Link href="/ops/individual-services" className="hover:text-white transition">Individual Services</Link></li>
                <li><Link href="/ops/escrow" className="hover:text-white transition">Escrow & Finance</Link></li>
                <li><Link href="/ops/developer" className="hover:text-white transition">Developer Services</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/ops/how-it-works" className="hover:text-white transition">How It Works</Link></li>
                <li><Link href="/ops/case-studies" className="hover:text-white transition">Case Studies</Link></li>
                <li><Link href="/ops/contractors" className="hover:text-white transition">For Contractors</Link></li>
                <li><Link href="/ops/pricing" className="hover:text-white transition">Pricing</Link></li>
                <li><Link href="/ops/demo" className="hover:text-white transition">Book a Demo</Link></li>
              </ul>
            </div>
