...
import { Button, Card, CardContent, Badge, Separator } from "@ops/components/ui"
import { ServiceTiers } from "@ops/components/development/ServiceTiers"
import { ProcessSteps } from "@ops/components/development/ProcessSteps"
import { FAQSection } from "@ops/components/development/FAQSection"
import {
  Shield,
  Target,
  TrendingUp,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <Link href="/ops/development/contact">Request a Project Review</Link>
              </Button>
              <Button
                asChild
                variant="outline"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            >
              <Link href="/ops/development/services">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            >
              <Link href="/ops/development/how-it-works">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Button
              ...
              className="border-2 border-gray-300 hover:border-orange-600 rounded-2xl"
            >
              <Link href="/ops/development/experience">
