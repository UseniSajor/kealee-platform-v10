  ...
  return (
    <div className="w-full">
      ...
      <section className="relative py-16">
        <Image src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1920&q=80&auto=format&fit=crop" alt="Project operations" fill className="object-cover" sizes="100vw" priority />
  ...
  const packages = [
    {
      ...
      features: ['Weekly status reports', 'Permit tracking', 'Basic sub coordination', 'Document organization', 'Email 48hr + monthly call', 'Max $500K/project'],
    },
    {
      name: 'Package B',
      ...
      popular: true,
      features: ['Everything in Package A', 'Full PM support', 'Client communication management', 'Budget tracking & variance alerts', 'Change order documentation', 'Priority email/phone 24hr + weekly calls', 'Max $2M/project'],
    },
    {
      name: 'Package C',
      subtitle: 'Premium',
      ...
      projects: 'Up to 15 projects',
      features: ['Everything in Package B', 'Dedicated PM team', 'Permit management', 'QA/QC observation', 'CO management', 'OAC meeting support', '4 site visits/month', '24/7 priority support', 'Max $5M/project'],
    },
    {
      name: 'Package D',
      subtitle: 'Enterprise',
      price: 'From $112,000',
      hours: '40+ hrs/week',
      projects: '15-20+ projects (D1-D4)',
      features: ['Everything in Package C', 'Dedicated account manager 24/7', '8 site visits/month', 'Executive dashboard & reporting', 'Custom SLAs & integrations', 'White-glove service', 'Max $10M/project'],
    },
  ]
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {packages.map((pkg) => (
          <div key={pkg.name} className={`rounded-2xl border bg-white p-6 shadow-sm flex flex-col ${pkg.popular ? 'border-sky-500 ring-1 ring-sky-500/20' : 'border-zinc-200'}`}>
            ...
            <Link href="/ops/contact" className={`mt-6 block text-center py-2.5 rounded-xl font-semibold transition ${pkg.popular ? 'bg-sky-500 text-white hover:bg-sky-600' : 'border border-zinc-200 hover:bg-zinc-50'}`}>
              Get Started
            </Link>
          </div>
        ))}
  ...
  return (
    <div>
      ...
      <div className="mt-8 text-center">
        ...
        <Link href="/ops/contact" className="inline-flex items-center justify-center rounded-xl bg-sky-500 px-6 py-2.5 text-sm font-semibold text-white hover:bg-sky-600 transition">
          Request a Quote
        </Link>
      </div>
    </div>
  ...
  return (
    <div>
      ...
      <div className="text-center">
        <Link href="/ops/escrow" className="inline-flex items-center justify-center rounded-xl bg-sky-500 px-6 py-2.5 text-sm font-semibold text-white hover:bg-sky-600 transition">
