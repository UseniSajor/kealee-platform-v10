  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20">
        <Image src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1920&q=80&auto=format&fit=crop" alt="Operations services" fill className="object-cover" sizes="100vw" priority />
