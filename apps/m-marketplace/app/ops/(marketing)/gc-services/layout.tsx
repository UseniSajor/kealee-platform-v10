...
import { Button } from "@ops/components/ui"
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/ops/gc-services" className="flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/ops/gc-services/services" className="text-sm hover:text-blue-600 transition-colors">Operations Packages</Link></li>
                <li><Link href="/ops/gc-services/pricing" className="text-sm hover:text-blue-600 transition-colors">Pricing</Link></li>
                <li><Link href="/ops/gc-services/how-it-works" className="text-sm hover:text-blue-600 transition-colors">How It Works</Link></li>
              </ul>
            </div>
