...
import { AIFeaturesShowcase } from "@ops/components/gc-services/AIFeaturesShowcase"
import {
  Shield,
  Clock,
  TrendingUp,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <Link href="/ops/gc-services/contact">Start Free 14-Day Trial</Link>
              </Button>
              <Button
                asChild
                variant="outline"
              ...
              >
                <Link href="/ops/gc-services/pricing">View All Pricing</Link>
              </Button>
            </div>
            ...
            {packages.map((pkg) => (
              ...
              >
                ...
                <CardContent className="pt-8">
                  ...
                  >
                    <Link href="/ops/gc-services/contact">{pkg.cta}</Link>
                  </Button>
                </CardContent>
              </Card>
            ))}
