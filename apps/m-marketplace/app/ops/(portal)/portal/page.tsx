...
import { ProjectHealth, type GCProjectHealth } from "@ops/components/portal/ProjectHealth";
import { GCSuccessDashboard } from "@ops/components/portal/GCSuccessDashboard";
import { api } from "@ops/lib/api";
import { getCurrentUser, getCurrentUserOrgs, getPrimaryOrgId } from "@ops/lib/auth";
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-black/10 bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 grid gap-2">
              <Link
                href="/ops/portal/service-requests/new"
                className="rounded-xl border border-black/10 bg-white px-4 py-2.5 text-sm font-black text-zinc-900 hover:bg-zinc-50"
              >
                Submit Service Request
              </Link>
              <Link
                href="/ops/portal/weekly-reports"
                className="rounded-xl border border-black/10 bg-white px-4 py-2.5 text-sm font-black text-zinc-900 hover:bg-zinc-50"
              >
                View Weekly Report
              </Link>
              <Link
                href="/ops/portal/my-projects"
                className="rounded-xl border border-black/10 bg-white px-4 py-2.5 text-sm font-black text-zinc-900 hover:bg-zinc-50"
              >
                Check Permit Status
              </Link>
              <Link
                href="/ops/portal/my-projects?new=1"
                className="rounded-xl border border-black/10 bg-white px-4 py-2.5 text-sm font-black text-zinc-900 hover:bg-zinc-50"
              >
                Add New Project
              </Link>
