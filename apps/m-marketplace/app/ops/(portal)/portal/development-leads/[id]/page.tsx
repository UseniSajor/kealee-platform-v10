...
import {Card, CardContent, CardHeader, CardTitle, Button, Badge, Input, Textarea, Select } from "@ops/components/ui"
import {
  ArrowLeft,
  Mail,
  Phone,
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <Button
            variant="ghost"
            onClick={() => router.push("/ops/portal/development-leads")}
            className="mb-4"
          >
