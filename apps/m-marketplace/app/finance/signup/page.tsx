      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              ...
              <label className="text-sm text-gray-600">
                I agree to the{' '}
                <a href="/finance/terms" className="text-emerald-600 hover:text-emerald-700">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="/finance/privacy" className="text-emerald-600 hover:text-emerald-700">
                  Privacy Policy
                </a>
              </label>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <a href="/finance/login" className="text-emerald-600 hover:text-emerald-700 font-semibold">
              Sign in
            </a>
          </p>
        </div>
