    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600">
                ...
                <Link href="/finance/pricing" className="text-emerald-600 font-semibold hover:underline">
      ...
      <div className="text-center text-sm text-gray-500 py-6 bg-gray-100">
        <p>
          ...
          <Link href="/finance/contractors" className="text-emerald-600 hover:text-emerald-700 underline">
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><Link href="/finance/help" className="hover:text-white transition-colors">Get Help</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><Link href="/finance/about" className="hover:text-white transition-colors">About Kealee</Link></li>
                <li><Link href="/finance/contact" className="hover:text-white transition-colors">Contact Us</Link></li>
                <li><Link href="/finance/legal/privacy" className="hover:text-white transition-colors">Privacy Policy</Link></li>
                <li><Link href="/finance/legal/terms" className="hover:text-white transition-colors">Terms of Service</Link></li>
                <li><Link href="/finance/legal/acceptable-use" className="hover:text-white transition-colors">Acceptable Use</Link></li>
              </ul>
            </div>
          </div>
