...
export class ProjectApiService {
  ...
  static async getProjects(params?: {
    ...
    // Use /pm/projects endpoint (not /pm/projects)
    ...
    return this.fetchWithAuth(`/pm/projects${query.toString() ? `?${query.toString()}` : ''}`);
  }

  static async getProject(projectId: string) {
    return this.fetchWithAuth(`/pm/projects/${projectId}`);
  }

  static async getMyProjects() {
    // Backend has GET /pm/projects which returns user's projects
    return this.fetchWithAuth('/pm/projects');
  }
  ...
  static async deleteProject(projectId: string) {
    // Note: Backend route may need to be created (DELETE /pm/projects/:id)
    return this.fetchWithAuth(`/pm/projects/${projectId}`, {
      method: 'DELETE',
    });
  }
  ...
  static async getProjectTimeline(projectId: string) {
    // Note: Backend route may need to be created (GET /pm/projects/:id/timeline)
    // Check if it exists at /pm/projects/:id/timeline
    try {
      return await this.fetchWithAuth(`/pm/projects/${projectId}/timeline`);
    } catch {
      // Fallback to /pm/projects/:id/timeline
      return this.fetchWithAuth(`/pm/projects/${projectId}/timeline`);
    }
  }
  ...
  static async addTeamMember(projectId: string, teamMember: {
    ...
    // Backend has POST /pm/projects/:id/members
    const body: any = {
      userId: teamMember.userId,
      role: teamMember.role,
    };

    return this.fetchWithAuth(`/pm/projects/${projectId}/members`, {
      method: 'POST',
      body: JSON.stringify(body),
    });
  }
  ...
  static async removeTeamMember(projectId: string, userId: string) {
    // Note: Backend route may need to be created (DELETE /pm/projects/:id/members/:userId)
    return this.fetchWithAuth(`/pm/projects/${projectId}/members/${userId}`, {
      method: 'DELETE',
    });
  }
  ...
  static async createMilestone(projectId: string, milestone: {
    ...
    // Note: Backend route may need to be created (POST /pm/projects/:id/milestones)
    const body = {
      name: milestone.name,
    ...
    return this.fetchWithAuth(`/pm/projects/${projectId}/milestones`, {
      method: 'POST',
      body: JSON.stringify(body),
    });
  }
  ...
  static async updateMilestone(projectId: string, milestoneId: string, updates: {
    ...
    // Note: Backend route may need to be created (PATCH /pm/projects/:id/milestones/:milestoneId)
    const body: any = {};
    if (updates.name !== undefined) body.name = updates.name;
    if (updates.description !== undefined) body.description = updates.description;
    ...
    return this.fetchWithAuth(`/pm/projects/${projectId}/milestones/${milestoneId}`, {
      method: 'PATCH',
      body: JSON.stringify(body),
    });
  }
  ...
  static async deleteMilestone(projectId: string, milestoneId: string) {
    // Note: Backend route may need to be created (DELETE /pm/projects/:id/milestones/:milestoneId)
    return this.fetchWithAuth(`/pm/projects/${projectId}/milestones/${milestoneId}`, {
      method: 'DELETE',
    });
  }
  ...
  static async getProjectBudget(projectId: string) {
    // Try /pm/projects/:id/pm/budget first
    try {
      return await this.fetchWithAuth(`/pm/projects/${projectId}/pm/budget`);
    } catch {
      // Fallback to /pm/projects/:id/pm/budget
      return this.fetchWithAuth(`/pm/projects/${projectId}/pm/budget`);
    }
  }
  ...
  static async getProjectReport(projectId: string) {
    // Note: Backend route may need to be created (GET /pm/projects/:id/report)
    return this.fetchWithAuth(`/pm/projects/${projectId}/report`);
  }

  static async getProjectBudgetReport(projectId: string) {
    // Note: Backend route may need to be created (GET /pm/projects/:id/pm/budget-report)
    return this.fetchWithAuth(`/pm/projects/${projectId}/pm/budget-report`);
  }

  static async getProjectProgressReport(projectId: string) {
    // Note: Backend route may need to be created (GET /pm/projects/:id/progress-report)
    return this.fetchWithAuth(`/pm/projects/${projectId}/progress-report`);
  }
  ...
  static async createProjectFromLead(leadId: string, orgId?: string) {
    // Backend has POST /pm/projects/from-lead/:leadId
    return this.fetchWithAuth(`/pm/projects/from-lead/${leadId}`, {
      method: 'POST',
