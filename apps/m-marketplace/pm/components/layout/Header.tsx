...
const quickCreateItems = [
  ...
  { label: "Daily Log", href: "/pm/daily-logs/new" },
  { label: "RFI", href: "/pm/rfis/new" },
  { label: "Change Order", href: "/pm/change-orders/new" },
  { label: "Punch Item", href: "/pm/punch-list/new" },
  { label: "Meeting", href: "/pm/meetings/new" },
]
