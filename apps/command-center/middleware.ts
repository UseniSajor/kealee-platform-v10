...
export async function middleware(request: NextRequest) {
  ...
  const protectedPaths = ['/twins', '/events', '/bots', '/integrations', '/analytics', '/launch', '/command-center']
...
export const config = {
  matcher: ['/', '/twins/:path*', '/events/:path*', '/bots/:path*', '/integrations/:path*', '/analytics/:path*', '/launch/:path*', '/command-center/:path*', '/login', '/signup'],
}
