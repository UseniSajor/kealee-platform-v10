# Kealee Command Center — Android / Google Play

This Bubblewrap project packages `https://command.kealee.com/command-center` as a
Trusted Web Activity.

## Identity

- Package ID: `com.kealee.commandcenter`
- Target SDK: Android 16 / API 36
- Minimum SDK: API 21
- Web origin: `https://command.kealee.com`
- Manifest: `https://command.kealee.com/site.webmanifest`
- Digital Asset Links: `https://command.kealee.com/.well-known/assetlinks.json`
