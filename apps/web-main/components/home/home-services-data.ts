...
export const HOME_JOURNEY_SERVICES: HomeJourneyService[] = [
  ...
  },
  {
    ...
    ctaLink: '/intake/preliminary_site_plan',
    gradientFrom: '#0F766E',
    gradientTo: '#2ABFBF',
    progress: 60,
    mediaType: 'photo',
  ...
  },
  {
    ...
    ctaLink: '/intake/permit_path_only?product=permit_assessment',
    gradientFrom: '#805AD5',
    gradientTo: '#B794F4',
    progress: 80,
    mediaType: 'video',
  ...
  },
  {
    ...
    ctaText: 'Start Build Support',
    ctaLink: '/intake/design_build?product=construction_consultation',
    gradientFrom: '#38A169',
    gradientTo: '#68D391',
    progress: 100,
    mediaType: 'video',
