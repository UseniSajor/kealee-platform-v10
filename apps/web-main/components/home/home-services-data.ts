...
export const HOME_JOURNEY_SERVICES: HomeJourneyService[] = [
  {
    ...
    subtitle: '3 Custom Designs',
    description:
      'Get 3 unique design concepts generated by AI based on your project details.',
  ...
  },
  {
    ...
    subtitle: 'DC Compliance Guide',
    description:
      'Understand all permit requirements and processes for your jurisdiction.',
    priceHint: usdRange(PERMIT_BASIC_PRICE, PERMIT_PREMIUM_PRICE),
    ctaText: 'Check Permits',
    ctaLink: '/permits',
    gradientFrom: '#2E5090',
    gradientTo: '#C38B5F',
    progress: 50,
  ...
  },
  {
    ...
    description:
      'Get a detailed cost breakdown including materials, labor, and contingency.',
  ...
  },
  {
    ...
    description:
      'Connect with vetted contractors and manage your project timeline.',
