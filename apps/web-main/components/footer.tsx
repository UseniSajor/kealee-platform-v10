...
const SOCIAL = [
  {
    label: 'Instagram',
    href: 'https://instagram.com/kealee',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/kealee',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-500 text-sm leading-relaxed mb-6">
              End-to-end design-build platform for project owners and professionals — AI design concepts, verified cost estimates, permit filing, and a shared project workspace from first idea to final build.
            </p>
          ...
          <div>
            ...
            <Link href="/concept">
              <button className="w-full bg-[#E8724B] hover:bg-[#D45C33] text-white font-bold py-3 px-5 rounded-xl transition-all duration-200 text-sm">
                Start Your Concept →
              </button>
            </Link>
          </div>
