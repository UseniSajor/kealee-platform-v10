import { CONCEPT_FROM, DRAWINGS_TO, PERMIT_MANAGED_FROM } from '@/lib/marketing/price-copy'
...
export default function HowItWorksSection() {
  return (
    <div className="sec" id="how-it-works">
      ...
      <p className="sub">Start with Step 1 from {CONCEPT_FROM}. Stop at any point. Add services when your project needs them.</p>
      <div className="fw">
        ...
        <div className="fwst">
          ...
          <div className="fwpr">{CONCEPT_FROM} → {DRAWINGS_TO}</div>
        </div>
        <div className="fwst">
          ...
          <div className="fwpr">Free → {PERMIT_MANAGED_FROM}</div>
        </div>
        <div className="fwst">
