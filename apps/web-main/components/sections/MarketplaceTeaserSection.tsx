    ...
    <div className="mkt" id="marketplace">
      <div className="mkti">
        ...
        <div className="mkt-row2">
          ...
          <div className="mc sm"><div className="mci">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=500&q=60&auto=format&fit=crop" alt="Basement" /></div><div className="mco" /><div className="mcb"><div className="mctag">design ready</div><h4>Basement finish</h4><p>Concept · Egress check · Permits</p></div></div>
        </div>
