...
export const PROCESS_SCRIPTS: Record<VideoNarrativeId, ProcessSegment[]> = {
  ...
  'design-reveal': [
    { id: 'garden', label: 'Garden & Landscape', prompt: `${BASE_REALISM}, slow pan across a beautifully designed modern backyard garden and landscape, stone paver patio, lush plants` },
    { id: 'addition', label: 'Home Addition', prompt: `${BASE_REALISM}, slow tilt showing a newly framed modern home addition exterior integrating with the original house` },
    { id: 'bath', label: 'Bath Design', prompt: `${BASE_REALISM}, slow dolly through a luxury spa-like bathroom, marble tiling, floating double vanity, warm accent lighting` },
    { id: 'kitchen', label: 'Kitchen Concept', prompt: `${BASE_REALISM}, slow cinematic reveal of a renovated modern kitchen interior with design concept boards visible on a tablet` },
  ],
  'permits-static': [],
  'permits-active': [],
  'estimate-motion': [
