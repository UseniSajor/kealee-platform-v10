...
export const PROCESS_SCRIPTS: Record<VideoNarrativeId, ProcessSegment[]> = {
  ...
  'full-build': [
    { id: 'foundation', label: 'Foundation', prompt: `${BASE_REALISM}, concrete pour, foundation forms being filled, steel rebar, cement mixer truck` },
    { id: 'framing', label: 'Framing', prompt: `${BASE_REALISM}, wood frame erection, roof trusses, house skeleton taking shape on suburban lot` },
    { id: 'envelope', label: 'Envelope', prompt: `${BASE_REALISM}, sheathing, house wrap, window installation, roof shingles going on` },
    { id: 'finishes', label: 'Finishes', prompt: `${BASE_REALISM}, exterior siding completion, painting, landscaping, trim work` },
    { id: 'complete', label: 'Completion', prompt: `${BASE_REALISM}, finished new construction modern home exterior, lush landscaping, golden hour sunset, move-in ready` },
  ],
  'landscape-install': [
  ...
  'design-reveal': [
    { id: 'site-photos', label: 'Property Photos', prompt: `${BASE_REALISM}, one designer reviews homeowner property photos and room measurements on a tablet beside printed plans` },
    { id: 'concept-boards', label: 'Concept Boards', prompt: `${BASE_REALISM}, close-up of floor plan sketches, material samples, and AI concept boards for a residential renovation spread across a design table` },
    { id: 'permit-path', label: 'Permit Path', prompt: `${BASE_REALISM}, zoning notes and permit path checklist next to concept drawings, professional preconstruction planning workspace` },
    { id: 'review', label: 'Design Review', prompt: `${BASE_REALISM}, calm slow pan over the completed Kealee concept package, tablet showing design options, no construction labor` },
  ],
  'permits-static': [],
  'permits-active': [],
  'estimate-motion': [
