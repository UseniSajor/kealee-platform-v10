  ...
  creative: [
    {
      ...
      description: 'design · Permit scope · Cost estimate',
      cta:         'Learn More',
    ...
    },
    {
      ...
      primaryText: `Stop guessing on your renovation. Kealee gives you an design concept, permit path, and matched contractors — before you spend a dollar on construction. Concepts from $${CONCEPT_START_PRICE}.`,
