...
const SERVICE_DELIVERABLE_DEFINITIONS: Record<string, ServiceDeliverable> = {
  ...
  preliminary_site_plan: {
    label: 'Preliminary Design Concept + Site Plan',
    category: 'development',
    agentType: 'land',
    generatesConcept: false,
    includes: [
      'Project brief, jurisdiction, stated program, design basis, source register, and assumptions',
      'Existing-conditions plan using available parcel, street, terrain, easement, utility, flood, soil, tree, and environmental sources—never invented geometry',
  ...
  permit_site_plan: {
    label: 'Full / Detailed Survey-Based Site Plan',
    category: 'development',
    agentType: 'land',
    generatesConcept: false,
    permitRequired: 'always',
    includes: [
      ...
      'Jurisdiction-specific detailed site plan drafted from your survey',
      'Yocum-standard technical organization adapted to the project scope: cover, existing conditions, site layout, grading/drainage, stormwater, utilities, roads, details, and landscape sheets when applicable',
