...
export const SERVICE_DELIVERABLES: Record<string, ServiceDeliverable> = {
  ...
  cost_estimate: {
    ...
    generatesConcept: false,
    includes: [
      'Cost estimate using documented regional references',
      'Trade-by-trade breakdown (GC, electrical, plumbing, HVAC, finishes)',
      'PDF report with scope and assumptions',
  ...
  contractor_match: {
    ...
    generatesConcept: false,
    includes: [
      'Available marketplace provider matches',
      'Displayed business and credential-review status',
  ...
  professional_drawings: {
    ...
    permitRequired: 'always',
    includes: [
      'Qualified design professional assigned when confirmed in writing',
      'AI concept review and integration into drawing set',
      'Permit-ready drawing set (floor plan, elevations, site plan)',
      'Professional stamp only when required, scoped, and supplied by the assigned professional',
  ...
  design_estimate_permit_bundle: {
    ...
    includes: [
      ...
      'MEP specification (electrical, plumbing, HVAC, lighting)',
      'Trade-by-trade cost estimate with documented references',
      VIDEO_PREMIUM_TIERS,
      CREDIT_TOWARD_PERMIT_DRAWINGS,
  ...
  estimate_permit_bundle: {
    ...
    permitRequired: 'always',
    includes: [
      'Cost estimate aligned to your concept with documented references',
