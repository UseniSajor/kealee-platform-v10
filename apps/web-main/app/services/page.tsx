...
const SERVICES = [
  {
    ...
    title: 'AI Concept Design Package',
    description: 'Answer 9 questions. Get photorealistic renderings, a design brief, cost estimate, zoning check, and permit path. Delivered to your portal in 5–7 business days.',
    price: 'From $599',
    note: 'Pre-design concept only — not a permit-ready plan.',
    href: '/intake-wizard',
    cta: 'Start the intake wizard',
    accent: '#E8793A',
    imgUrl: 'https://images.unsplash.com/photo-1584622781564-1d987f7333c1?w=700&q=60&auto=format&fit=crop',
    tiers: [
      { name: 'Starter — up to 800 sq ft', price: '$599', pop: true },
      { name: 'Professional — up to 3,000 sq ft', price: '$1,299' },
      { name: 'Enterprise — 3,000+ sq ft', price: 'CFQ' },
    ],
  },
  {
    tag: 'Permit Services',
    title: 'Permit Filing & Tracking',
    description: 'Kealee prepares and submits every tier. We know DC DOB, Montgomery DPS, Fairfax LDS, and every DMV agency. Biweekly updates in your portal.',
    price: 'From $495',
    note: 'Kealee submits every tier. Requires architect-stamped plans.',
    href: '/permits',
    ...
    tiers: [
      { name: 'Standard — single-trade projects', price: '$495' },
      { name: 'Multi-Trade', price: '$895', pop: true },
      { name: 'Full Service — unlimited revisions', price: '$1,495' },
    ],
  },
  {
    tag: 'Design Services',
  ...
  },
  {
    ...
    tiers: [
      { name: 'AI Concept + Cost Estimate bundle', price: 'From $694' },
  ...
  },
  {
    ...
    tiers: [
      ...
      { name: 'AI Concept + Contractor Match', price: 'From $599', pop: true },
