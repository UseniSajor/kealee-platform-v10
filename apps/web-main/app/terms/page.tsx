      ...
      <section className="space-y-8 text-sm leading-7">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1 mt-2">
            <li><strong>Concept Packages</strong> — AI-generated design concepts, floor plan options, scope summaries, and cost estimates for home improvement projects</li>
        ...
        <div>
          <h2 id="refunds" className="scroll-mt-24 text-lg font-semibold mb-2">4. Payments and Refunds</h2>
          <p>
        ...
        <div>
          <h2 id="ai-use" className="scroll-mt-24 text-lg font-semibold mb-2">5. AI-Generated Content</h2>
          <p>
