  ...
  try {
    ...
    await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [to],
        subject: 'Your Kealee project is saved',
        text: [
          `Hi ${firstName},`,
          '',
          'Your project details are saved for:',
          `  ${service} — $${amountFormatted}`,
          '',
          'You have not been charged.',
          '',
          `Choose a payment method and continue when you are ready: ${retryUrl}`,
          '',
          'Reply to this email if you would like help. We will assist you within the hour.',
          '',
          '— The Kealee Team',
          'hello@kealee.com',
        ].join('\n'),
