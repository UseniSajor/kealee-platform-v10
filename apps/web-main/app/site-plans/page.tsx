...
const inclusions: Record<(typeof productKeys)[number], string[]> = {
  ...
  permit_site_plan: [
    'Boundary or survey intake',
    'Jurisdiction-specific site-plan scope',
    'Professional coordination',
    'Permit submission drawing workflow',
    'Comment-response coordination scope',
  ],
}
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-6 lg:grid-cols-3">
            {products.map((product, index) => {
              ...
              return (
                <article key={product.key} className="flex flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-center text-xs leading-relaxed text-slate-500">
            ...
            A preliminary site plan is not a boundary survey. Source coverage and accuracy vary by jurisdiction.
          </p>
        </div>
      </section>
    </main>
