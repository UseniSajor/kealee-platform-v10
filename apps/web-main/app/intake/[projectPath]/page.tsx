...
const PRICE_MAP: Record<string, { label: string; amount: number; delivery: string }> = {
  ...
  cost_estimate: { label: 'Detailed Cost Estimate', amount: 59500, delivery: '3–5 days' },
  certified_estimate: { label: 'Certified Cost Estimate', amount: 185000, delivery: '5–7 days' },
