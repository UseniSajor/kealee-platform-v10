...
const PHASES_DETAIL = [
  {
    ...
    icon: Brain,
    color: '#2ABFBF',
    title: 'Phase 1: AI Design Concepts',
    subtitle: 'AI Design Capture & Brief',
    ...
    features: [
      ...
      'AI-powered photorealistic renders and material palettes',
...
const PORTAL_FEATURES = [
  {
    ...
    icon: Eye,
    color: '#2ABFBF',
    highlights: ['Real-time project dashboard', 'Payment tracking & approvals', 'Project history & documents', 'AI design insights', 'Document library', 'Inspection status'],
  },
  {
    id: 'contractor',
