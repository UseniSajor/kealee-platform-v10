...
const STANDARD_ROUTES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/privacy`, changeFrequency: 'yearly', priority: 0.35 },
  { url: `${BASE_URL}/terms`, changeFrequency: 'yearly', priority: 0.35 },
  { url: `${BASE_URL}/service-policies`, changeFrequency: 'monthly', priority: 0.5 },
