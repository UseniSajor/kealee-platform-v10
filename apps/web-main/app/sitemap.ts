...
const HIGH_PRIORITY_ROUTES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/services/site-plan`, changeFrequency: 'weekly', priority: 0.9 },
  { url: `${BASE_URL}/services/design-concept`, changeFrequency: 'weekly', priority: 0.9 },
  { url: `${BASE_URL}/services/cost-estimate`, changeFrequency: 'weekly', priority: 0.9 },
  { url: `${BASE_URL}/services/permits`, changeFrequency: 'weekly', priority: 0.9 },
  { url: `${BASE_URL}/services/contractor-match`, changeFrequency: 'weekly', priority: 0.85 },
  { url: `${BASE_URL}/services/escrow-protection`, changeFrequency: 'weekly', priority: 0.85 },
