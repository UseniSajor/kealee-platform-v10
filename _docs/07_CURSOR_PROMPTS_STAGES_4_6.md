# CURSOR PROMPTS: STAGES 4-6
## Project Owner + Finance & Trust + Marketplace

**Stages Covered:** 4, 5, 6 (Weeks 9-17)  
**Total Prompts:** ~200

---

## STAGE 4: PROJECT OWNER HUB — COMPLETE BUILD PROMPTS (WEEKS 9-11)

### Integration Dependencies
- **Requires**: OS Foundation (Stage 1), Ops OS Core (Stage 2), Ops Services (Stage 3)
- **Integrates With**:
  - `m-finance-trust` (escrow) *(Stage 5; implement integration contracts + stubs until built)*
  - `m-permits-inspections` (compliance gates) *(Stage 7.5; implement integration contracts + stubs until built)*
- **Data Models**: `Project`, `ContractAgreement`, `Milestone`, `Evidence`, `ReadinessItem` *(plus `Property` from OS Foundation)*
...
## GLOBAL REQUIREMENTS (APPLY TO ALL STAGE 4 COMPONENTS)
...
## INTEGRATION CHECKLIST (STAGE 4 EXIT CRITERIA)
...
## WEEK 11 LAUNCH DELIVERABLES (STAGE 4 OUTPUTS)
...
[Full ~60 prompts would be included here]
...
**For complete prompts, see full version of this file**
